...
|---------|--------|-------|
| Hedera Account ID | Not shown / null | ✅ Displayed correctly |
| TEC Balance | Always 0 | ✅ Shows real balance |
| Token ID | Not shown | ✅ Displayed in purple box |
| Login after logout | ❌ Failed | ✅ Works perfectly |
| Database | ❌ Crashed | ✅ Stable |
| Data refresh | ❌ Stale | ✅ Real-time updates |
